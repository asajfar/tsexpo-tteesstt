...
<head>
  ...
  <!-- Basic -->
  <title>PROFIL IZLAGAČA | TRAFFIC SOLUTIONS EXPO</title>
        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>PROFIL IZLAGAČA</span></h4>

              <!-- Some Text -->
              <!-- <p><strong>Profil izlagača:</strong></p> -->
              <p>Izlagači na TRAFFIC SOLUTIONS EXPO su proizvođači, uvoznici proizvoda i/ili pružaoci različitih usluga iz svih vidova saobraćaja (drumski, železnički, vodni, avio i ptt saobraćaj).</p>
              <p>Izlagačke oblasti su:</p>
              <ul class="icons-list">
                <li><i class="fa fa-check-circle"></i>Politike, strategije i planovi razvoja u saobraćaju</li>
                <li><i class="fa fa-check-circle"></i>Saobraćajni inženjering - planiranje i projektovanje objekata u saobraćaju, nadzor i konsalting</li>
                <li><i class="fa fa-check-circle"></i>Sistemi i oprema (hardver i softver) za projektovanje, upravljanje, merenje, praćenje i kontrolu saobraćaja</li>
                <li><i class="fa fa-check-circle"></i>Izgradnja i održavanja saobraćajne infrastrukture</li>
                <li><i class="fa fa-check-circle"></i>Mehanizacija i oprema za izgradnju i održavanje saobraćajne infrastrukture</li>
                <li><i class="fa fa-check-circle"></i>Signalizacija i oprema u saobraćaju</li>
                <li><i class="fa fa-check-circle"></i>Prevoz putnika – planiranje i organizacija prevoza, vozila i prateća oprema</li>
                <li><i class="fa fa-check-circle"></i>Logistika, transport i usluge u transportu – pakovanje, pretovar, skladištenje robe i špediterski poslovi</li>
                <li><i class="fa fa-check-circle"></i>Mehanizacija i oprema za pakovanje, transport, pretovar i skladištenje robe</li>
                <li><i class="fa fa-check-circle"></i>Usluge u PTT saobraćaju – poštanske pošiljke, telekomunikacije i veze</li>
                <li><i class="fa fa-check-circle"></i>Obuke, stručne edukacije i edukacije učesnika u saobraćaju</li>
                <li><i class="fa fa-check-circle"></i>Osiguranje u saobraćaju – osiguranje putnika, robe, vozila i opreme</li>
                <li><i class="fa fa-check-circle"></i>Kreditiranje poslova i preduzeća iz oblasti saobraćaja</li>
                <li><i class="fa fa-check-circle"></i>Mediji i izdavaštvo u oblasti saobraćaja</li>
                <li><i class="fa fa-check-circle"></i>Ostale usluge u saobraćaju – snabdevanje gorivima, tehnički pregledi, održavanje vozila ili opreme, pomoć na putu i slično</li>
              </ul>
