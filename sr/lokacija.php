...
<head>
  ...
  <!-- Basic -->
  <title>KONTAKT | TRAFFIC SOLUTIONS EXPO</title>
      ...
      (function($) {
        $.fn.CustomMap = function(options) {
          ...
          var settings = $.extend({
            ...
            text: '<div class="map-popup"><h4>Novosadski sajam | Hajduk Veljkova 11</h4><p>21000 Novi Sad, Srbija, +381 21 483 0000</p></div>',
            icon_url: '../en/images/map-icon.png'/*$('#map').data('marker-img')*/,
            zoom: 15
          }, options);
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title"><span>Novosadski sajam</span></h4>
            ...
            <div>
              <div>
                ...
                <div class="touch-slider slider-margin" data-slider-navigation="true" data-slider-pagination="true">
                  <div class="item"><img alt="" src="../en/images/sajam/001_slika-sajam.jpg"></div>
                  <div class="item"><img alt="" src="../en/images/sajam/004_slika-sajam.jpg"></div>
                  <div class="item"><img alt="" src="../en/images/galerija2017/39_Otvaranje.jpg"></div>
                  <div class="item"><img alt="" src="../en/images/galerija2017/123_Edukativni deo.jpg"></div>
                  <div class="item"><img alt="" src="../en/images/sajam/005_slika-sajam.jpg"></div>
                  <div class="item"><img alt="" src="../en/images/sajam/006_slika-sajam.jpg"></div>
                </div>
                <!-- End Touch Slider -->
            </div>
          ...
          <div class="col-md-6">
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title"><span>Kongresni centar "Master" Novosadskog sajma</span></h4>
            ...
            <!-- Info - Icons List -->
            <ul class="icons-list">
              <li><i class="fa fa-map-marker">  </i> <strong>Adresa:</strong> Hajduk Veljkova, 21000 Novi Sad, Srbija</li>
              <li><i class="fa fa-envelope-o"></i> <strong>Email:</strong> kongresnicentar@sajam.net</li>
              <li><i class="fa fa-globe"></i> <strong>Veb-sajt:</strong> <a href="http://www.sajam.net" target='_blank'>www.sajam.net</a> ili <a href="http://www.kongresnicentar.sajam.net">www.kongresnicentar.sajam.net</a></li>
              <li><i class="fa fa-phone"></i> <strong>Telefon:</strong> +381 (0)21 483 07 77</li>
            </ul>
            <div class="hr1" style="margin-bottom:10px;"></div>
            ...
            <ul class="icons-list">
              ...
              <li><i class="fa fa-mobile"></i> <strong>Mobilni:</strong> +381 (0)64 124 97 57 i +381 (0)63 417 555</li>
            </ul>
            ...
            <!-- Classic Heading -->
            <!-- <h4 class="classic-title"><span>"Master" kongresni centar</span></h4> -->

            <!-- Info - List -->
            <!-- <ul class="icons-list">
              <li><i class="fa fa-map-marker">  </i> <strong>Adresa:</strong> Hajduk Veljkova, 21000 Novi Sad, Srbija</li>
              <li><i class="fa fa-envelope-o"></i> <strong>Email:</strong> congresscentre@novisadexpo.com</li>
              <li><i class="fa fa-mobile"></i> <strong>Telefon:</strong> +381 (0)21 483 0777, 483 0778</li>
              <li><i class="fa fa-globe"></i> <strong>Veb-sajt:</strong> <a href="http://www.novisadexpo.com" target='_blank'>www.novisadexpo.com</a></li>
            </ul> -->
