...
<head>
  ...
  <!-- Basic -->
  <title>PROGRAM | TRAFFIC SOLUTIONS EXPO</title>
...
<body>
        ...
        <div class="page-content">
          ...
          <div class="row"> <!-- Da se ne bi video program u ovaj red ubaciti style="display: none;" -->
            ...
            <div class="col-md-12">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>PROGRAM</span></h4>
            ...
            <div class="schedule-box clearfix wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <ul class="tab-buttons clearfix">
                   <!--  <li class="tab-btn active" data-id="#monday"><span class="day">Četvrtak</span><span class="date">13.10.2016.</span><span class="curve"></span></li>
                    ...
                    <li class="tab-btn active" data-id="#wednesday"><span class="day">Sreda</span><span class="date">16.10.2019.</span><span class="curve"></span></li>
                    <li class="tab-btn" data-id="#thursday"><span class="day">Četvrtak</span><span class="date">17.10.2019.</span><span class="curve"></span></li>
                    <li class="tab-btn" data-id="#friday"><span class="day">Petak</span><span class="date">18.10.2019.</span><span class="curve"></span></li>
                </ul>
                        ...
                        <!-- <div class="hour-box">
                            ...
                            <div class="content-box">
                                <div class="content">
                                    ...
                                    <h5>CILJEVI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Upoznavanje sa novinama u pravnoj regulativi u oblasti puteva, drumskog i železničkog saobraćaja.</li>
                                      <li><i class="fa fa-check-circle"></i>Razmena informacija i iskustva kod inspekcijskog nadzora.</li>
                                      <li><i class="fa fa-check-circle"></i>Informacije o novostima iz sudske prakse.</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>TEMATSKE OBLASTI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Bezbednost saobraćaja na putnim prelazima. <span style="font-style:italic;">- Nosilac teme je Jovo Milanović, pokrajinski inspektor za željeznički saobraćaj.</span></li>
                                      <li><i class="fa fa-check-circle"></i>Aktuelnosti iz oblasti prevoza putnika i tereta u drumskom saobraćaju. <span style="font-style:italic;">- Nosilac teme je Branislav Pažur, pokrajinski inspektor za drumski saobraćaj.</span></li>
                                      <li><i class="fa fa-check-circle"></i>Aktuelnosti koje je doneo novi zakon o putevima. <span style="font-style:italic;">- Nosilac teme je Zorica Pavićević, pokrajinski inspektor za državne puteve.</span></li>
                                       <li><i class="fa fa-check-circle"></i>Prikaz organizacije i rada inspektorata Republike Srpske. <span style="font-style:italic;">- Danislav Drašković, direktor Inspektorata R.S.</span></li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>Kontakt:</h5>
                                    <ul class="icons-list program-list">
                        ...
                        <!-- <div class="hour-box">
                            ...
                            <div class="content-box">
                                <div class="content">
                                    ...
                                    <h5>ORGANIZATORI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Fakultet tehničkih nauka u Novom Sadu, Univerzitet u Novom Sadu;</li>
                                      <li><i class="fa fa-check-circle"></i>Saobraćajni fakultet u Beogradu, Univerzitet u Beogradu;</li>
                                      <li><i class="fa fa-check-circle"></i>Kriminalističko-policijska akademija, Zemun;</li>
                                      <li><i class="fa fa-check-circle"></i>Republika Srbija, Agencija za bezbednost saobraćaja;</li>
                                      <li><i class="fa fa-check-circle"></i>Udruženje za bezbednost saobraćaja Srbije.</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>CILJEVI:</h5>
                                    ...
                                    <h5>TEMATSKE OBLASTI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Organizacija i sprovođenje bezbednosti saobraćaja;</li>
                                      <li><i class="fa fa-check-circle"></i>Bezbedniji učesnici u saobraćaju;</li>
                                      <li><i class="fa fa-check-circle"></i>Bezbedniji putevi i kretanje;</li>
                                      <li><i class="fa fa-check-circle"></i>Bezbednija vozila;</li>
                                      <li><i class="fa fa-check-circle"></i>Aktivnosti nakon nezgode.</li>
                                    ...
                                    <h5>VAŽNI DATUMI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>01. avgust 2018. – Registracija i prijava apstrakta (putem sajta: <a href="http://www.yubs.rs" target="_blank">www.yubs.rs</a>)</li>
                                      <li><i class="fa fa-check-circle"></i>10. avgust 2018. – Obaveštavanje autora o prihvatanju rada</li>
                                      <li><i class="fa fa-check-circle"></i>15. septembar 2018. – Dostava radova (putem sajta: <a href="http://www.yubs.rs" target="_blank">www.yubs.rs</a>)</li>
                                      <li><i class="fa fa-check-circle"></i>25. septembar 2018. – Recenzija radova</li>
                                      <li><i class="fa fa-check-circle"></i>01. oktobar 2018. – Konačan Program Simpozijuma</li>
                                      <li><i class="fa fa-check-circle"></i>17. oktobar 2018. – Svečano otvaranje Simpozijuma</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>KONTAKT:</h5>
                                    <ul style="margin-top: 10px;" class="icons-list program-list">
                                      <p style="margin-bottom: 0px;"><strong>U vezi simpozijuma:</strong></p>
                                      <li style="padding-left: 10px; margin-bottom: 10px;"><span style="font-weight:700;">Boško Matović, MSc</span><br>Tel: (+381) 21 485 2494 <br>Fax: (+381) 21 450 644 <br>Mob: (+381) 66 910 8092 <br>e-mail: <a href="mailto:boskom@uns.ac.rs">boskom@uns.ac.rs</a></li>
                                      <p style="margin-bottom: 0px;"><strong>U vezi smeštaja:</strong></p>
                                      <li style="padding-left: 10px; margin-bottom: 10px;"><span style="font-weight:700;">Balkanija d.o.o. Novi Sad</span><br>Tel: (+381) 21 301 45 90 <br>Žika: (+381) 64 12 37 612 <br>Sonja: (+381) 65 984 27 122 <br>e-mail: <a href="mailto:info@balkanija.rs">info@balkanija.rs</a> <br>Web: <a href="http://www.balkanija.rs" target="_blank">www.balkanija.rs</a></li>
                                    </ul>
                                </div>
                                <br>
                                <div class="row professional clearfix">
                        ...
                        <!-- <div class="hour-box">
                            ...
                            <div class="content-box">
                                <div class="content">
                                    <h5>ORGANIZATOR:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>AMSS - Centar za motorna vozila d.o.o.</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>CILJEVI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Upoznati predstavnike transportnih preduzeća sa mogućnostima da se kroz treninge i unapređenje znanja unapredi i efikasnost poslovanja preduzeća;</li>
                                      <li><i class="fa fa-check-circle"></i>Predstaviti modele koji su praktično primenljivi i efikasni u pogledu unapređenja bezbednosti vozača i vozila preduzeća;</li>
                                      <li><i class="fa fa-check-circle"></i>Predstaviti modele za ispunjavanje zakonskih obaveza transportnih preduzeća u pogledu praćenja i evidentiranja rada vozača i vozila;</li>
                                      <li><i class="fa fa-check-circle"></i>Predstaviti modelu uspostavljanja periodične obuke CPC-a, kao elementa koji unapređuje rad vozača i doprinosi efikasnijim transportnim procesima.</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>TEMATSKE OBLASTI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Unapređenje bezbednosti saobraćaja u transportnim preduzećima;</li>
                                      <li><i class="fa fa-check-circle"></i>Unapređenje znanja i veština vozača kompanije;</li>
                                      <li><i class="fa fa-check-circle"></i>Zakonske obaveze transportnih preduzeća;</li>
                                      <li><i class="fa fa-check-circle"></i>Periodična obuka CPC - prilika za unapređenje znanja i veština;</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>AGENDA RADIONICE:</h5>
                                    <ul class="icons-list program-list">
                                      <li>Registracija i podela materijala,</li>
                                      <li>Izazovi u radu transportnih preduzeća,</li>
                                      <li>Nove mogućnosti teorijskih i praktičnih obuka,</li>
                                      <li>Unapređenje efikasnosti rada transportnih preduzeća - primenjeni model analize,</li>
                                      <li>Okrugli sto - tema: Zakonske obaveze transportnih preduzeća,</li>
                                      <li>Koktel za goste</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>KONTAKT:</h5>
                                    <ul style="margin-top: 10px;" class="icons-list program-list">
                                      <li style="padding-left: 10px; margin-bottom: 10px;"><span style="font-weight:700;">Darko Petrović</span><br>e-mail: <a href="mailto:darko.petrovic@cmv.rs">darko.petrovic@cmv.rs</a></li>
                                    </ul>
                                </div>
                                <br>
                                <div class="row professional clearfix">
                        ...
                        <!-- <div class="hour-box">
                            ...
                            <div class="content-box">
                                <div class="content">
                                    <h5>ORGANIZATOR:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Aetrcontrol kft, Budimpešta</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>CILJEVI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Prezentacija programa za očitavanje i analizu podataka sa vozačkih kartica i tahografa uz potpunu primenu odredbi i zakona.</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>TEMATSKE OBLASTI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Očitavanje vozačkih kartica i tahografa na bazi interneta;</li>
                                      <li><i class="fa fa-check-circle"></i>Obrada taholistića</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>KONTAKT:</h5>
                                    <ul style="margin-top: 10px;" class="icons-list program-list">
                                      <li style="padding-left: 10px; margin-bottom: 10px;"><span style="font-weight:700;">Janoš Šajti</span><br>Tel: +362 04 624-552<br>e-mail: <a href="mailto:sajti.janos@aetrcontrol.eu">sajti.janos@aetrcontrol.eu</a></li>
                                    </ul>
                                </div>
                                <br>
                                <div class="row professional clearfix">
                      ...
                      <div><p>USKORO!</p></div>
                        ...
                        <!-- <div class="hour-box">
                            ...
                            <div class="content-box">
                                <div class="content">
                                    ...
                                    <h5>CILJEVI:</h5>
                                    <ul class="icons-list program-list">
                                      <li><i class="fa fa-check-circle"></i>Informisanje o Pravnom okviru organizacije i funkcionisanja Privrednih društava koja vrše tehnički pregled vozila</li>
                                    </ul>
                                    <div class="hr1" style="margin-bottom:10px;"></div>
                                    <h5>TEMATSKE OBLASTI:</h5>
                                    <ul class="icons-list program-list">
                       ...
                       <!--  <div class="hour-box">
                        ...
                        <!-- <div class="hour-box">
                            ...
                            <div class="img-circle circle"><span></span></div>
                            <div class="toggle-btn"><h3>Događaj 2</h3></div>
                            <div class="content-box">
                                <div class="content"><p>Informacije odogađaju.</p></div>
                                <br>
                                <div class="row professional clearfix">
                                    <div class="col-md-6 col-sm-6 col-xs-12 info">
                                        <figure class="img-circle image"><img class="img-circle" src="images/resource/testi-thumb-1.jpg" alt=""></figure>
                        ...
                        <!-- <div class="hour-box">
                            ...
                            <div class="img-circle circle"><span></span></div>
                            <div class="toggle-btn"><h3>Događaj 3</h3></div>
                            <div class="content-box">
                                <div class="content"><p>Informacije odogađaju.</p></div>
                                <br>
                                <div class="row professional clearfix">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                        ...
                                        <a href="#" class="theme-btn btn-style-one hvr-bounce-to-right dull">Vreme 3 - Vreme 4</a>
                                        <a href="single-event.html" class="theme-btn btn-style-one hvr-bounce-to-right"><span class="fa fa-play"></span>Detalji događaja</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- <div class="hour-box">
                            <div class="hour">Vreme 4</div>
                            <div class="img-circle circle"><span></span></div>
                            <div class="toggle-btn"><h3>Događaj 4</h3></div>
                            <div class="content-box">
                                <div class="content"><p>Informacije odogađaju.</p></div>
                                <br>
                                <div class="row professional clearfix">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                        ...
                                        <a href="#" class="theme-btn btn-style-one hvr-bounce-to-right dull">Vreme 4 - Vreme 5</a>
                                        <a href="single-event.html" class="theme-btn btn-style-one hvr-bounce-to-right"><span class="fa fa-play"></span>Detalji događaja</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- <div class="hour-box">
                            <div class="hour">Vreme 5</div>
                            <div class="img-circle circle"><span></span></div>
                            <div class="toggle-btn"><h3>Događaj 5</h3></div>
                            <div class="content-box">
                                <div class="content"><p>Informacije odogađaju.</p></div>
                                <br>
                                <div class="row professional clearfix">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                        ...
                                        <a href="#" class="theme-btn btn-style-one hvr-bounce-to-right dull">Vreme 5 - Vreme 6</a>
                                        <a href="single-event.html" class="theme-btn btn-style-one hvr-bounce-to-right"><span class="fa fa-play"></span>Detalji događaja</a>
                                    </div>
                                </div>
                            </div>
  ...
  <!-- <script src="../en/jspr/jquery.js"></script> --> 
  <!-- <script src="../en/jspr/bootstrap.min.js"></script> -->
  <!-- <script src="../en/jspr/revolution.min.js"></script> -->
  <!-- <script src="../en/jspr/bxslider.js"></script> -->
  <!-- <script src="../en/jspr/owl.carousel.min.js"></script> -->
  <!-- <script src="../en/jspr/jquery.fancybox.pack.js"></script> -->
  <script src="../en/jspr/wow.js"></script>
  <!-- <script src="../en/jspr/jquery.countdown.js"></script> -->
  <script src="../en/jspr/scriptpr.js"></script>
