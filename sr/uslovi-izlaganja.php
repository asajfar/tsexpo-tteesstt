...
<head>
  ...
  <!-- Basic -->
  <title>USLOVI IZLAGANJA | TRAFFIC SOLUTIONS EXPO</title>
        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>CENOVNIK USLUGA</span></h4>
              <!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-left-padding">
                <p style="margin-bottom: 50px">Cenovnik usluga će USKORO biti dostupan!</p>
              </div> -->
                ...
                <div class="db-wrapper">
                    <div class="db-pricing-seven">
                        <ul>
                            ...
                            <li><span style="font-weight: bold">Prostor bez štand konstrukcije</span> (Cena je izražena po m²):</li>
                            <li class="kolona">2.400,00</li>
                            <li><span style="font-weight: bold">Štand – Tip I-52m²</span> (prostor, štand konstrukcija, sto sa stolicama, struja i grafika)</li>
                            <li class="kolona" style="line-height: 3em;">408.000,00</li>
                            <li><span style="font-weight: bold">Štand – Tip II-24m²</span> (prostor, štand konstrukcija, sto sa stolicama, struja i grafika)</li>
                            <li class="kolona" style="line-height: 3em;">192.000,00</li>
                            <li><span style="font-weight: bold">Štand – Tip III-12m²</span> (prostor, štand konstrukcija, sto sa stolicama, struja i grafika)</li>
                            <li class="kolona" style="line-height: 3em;">108.000,00</li>
                            <li><span style="font-weight: bold">Pult</span> (dve stolice i priključak za struju)/kom:</li>
                            <li class="kolona">27.000,00</li>
                            <li><span style="font-weight: bold">Konferencijska sala za prezentacije</span> (cena je izražena za salu od 100 mesta/1h):</li>
            ...
            <!-- Price Table Begin -->
              ...
              <!-- Pocetak fotogalerije -->
              <!-- <h4 class="classic-title"><span>IZGLED ŠTANDA - TS-EXPO 2017</span></h4>
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-left-padding"> -->
                <!-- Start image gallery -->
                <!-- <div class="galerija-widget">
                  <ul class="galerija-list">
                    <li>
                      <a href="../en/images/exhibition/st-1.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-1.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-2.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-2.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-3.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-3.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-4.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-4.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-5.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-5.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-6.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-6.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-7.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-7.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-8.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-8.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/st-9.jpg" class="lightbox" data-lightbox-gallery="standovi">
                        <img alt="" src="../en/images/exhibition/st-9.jpg">
                      </a>
                    </li>
                  </ul>
                </div>
            ...
            <!-- kraj foto galerije -->
	          <!-- <div class="registration">
	            <a href="../en/docs/reg/Opsti_uslovi_za_izlaganje.pdf" target="_blank"><button class="register-button-izv2"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Opšti uslovi za izlaganje</button></a>
	    	  </div>  -->
            ...
            <div class="col-md-6">
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>KONSTRUKCIJA ŠTANDA</span></h4>

              <!-- Some Text -->
              <p>Štandovi sadrže sledeću opremu, nameštaj i priključke:</p>
              <ul class="icons-list">
                <li><i class="fa fa-check-circle"></i>stoni štender</li>
                <li><i class="fa fa-check-circle"></i>sto (1)</li>
                <li><i class="fa fa-check-circle"></i>stolice (3)</li>
                <li><i class="fa fa-check-circle"></i>pult i barska stolica (1)</li>
                <li><i class="fa fa-check-circle"></i>skladište od 1 m² sa mogućnošću zaključavanja</li>
                <li><i class="fa fa-check-circle"></i>pregradni zidovi (beli), visine od 250 cm</li>
                <li><i class="fa fa-check-circle"></i>itison u pločama</li>
                <li><i class="fa fa-check-circle"></i>pult (beli) sa imenom kompanije i brojem štanda</li>
                <li><i class="fa fa-check-circle"></i>reflektori (2) na 5 m²</li>
                <li><i class="fa fa-check-circle"></i>utičnica (1) od 220 volti</li>
                <li><i class="fa fa-check-circle"></i>struja (snaga tokom dana) i potrošnja za standardnu utičnicu od 220V i sa standardnim reflektorima</li>
              </ul>
              <div class="hr1" style="margin-bottom:50px;"></div>

              <h4 class="classic-title"><span>IZGLED ŠTANDA</span></h4>

              <!-- Start image gallery -->
                <div class="flickr-widget">
                  <ul class="flickr-list">
                    <li>
                      <a href="../en/images/exhibition/stand1.jpg" class="lightbox">
                        <img alt="" src="../en/images/exhibition/stand1.jpg">
                      </a>
                    </li>
                    <li>
                      <a href="../en/images/exhibition/stand2.jpg" class="lightbox">
