...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       KORISNICI
        <small>Podaci o registrovanim članovima</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Prikaz podataka registrovanih članova</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div style="margin-bottom: 15px">
                Isključi/uključi kolone za prikaz: <a href="#" class="toggle-vis" data-column="0">Ime</a> - <a href="#" class="toggle-vis" data-column="1">Prezime</a> - <a href="#" class="toggle-vis" data-column="2">Deo grada</a> - <a href="#" class="toggle-vis" data-column="3">Adresa</a> - <a href="#"  class="toggle-vis" data-column="4">Mobilni</a> - <a href="#"  class="toggle-vis" data-column="5">Email</a>
              </div>
              <table id="tabela2" class="table table-hover table-bordered table-striped">
                <thead>
                  <tr>
                      <th>Ime</th>
                      <th>Prezime</th>
...
<script>
  ...
  <script>
    ...
    $('#tabela2 tfoot th').each( function () {
        var title = $(this).text();
