<?php
  ...
  if(isset($_POST['submit_vest']))
  {
    $stmt = $panel_home->runQuery("SELECT * FROM tbl_members");
    $stmt->execute();

    foreach ($stmt as $row)
    {
      $email = $row['memberEmail'];
      //$email = "asajfar@gmail.com";
      $ime = $row['memberName'];
      ...
      $message = "Poštovani/a $ime $prezime
                  ...
                  <br /><br />
                  <br /><br />
                  :::: Ovu poruku ste primili jer ste registrovani u našoj bazi. Ukoliko želite da otkažete registraciju, molimo Vas da nas kontaktirate na registracija@sbsns.rs ::::
                  <br /><br />
                  <br /><br />
                  S poštovanjem,
                  <br /><br />
      ...
      $subject = $_POST['naslov_vest'];

      // Always set content-type when sending HTML email
      $headers = "MIME-Version: 1.0" . "\r\n";
      $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
      // More headers
      $headers .= 'From: <registracija@sbsns.rs>' . "\r\n";

      mail($email,$subject,$message,$headers);

    }

    $poruka = "Uspešno ste poslali vest!";
        header("Location: posalji-vest.php?poslato=$poruka");
  }
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          <a href="#"><i class="fa fa-paper-plane-o"></i> <span>Pošalji vest članovima</span>
          </a>
        </li>
        <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       POŠALJI VEST
        <small>Pošalji vesti svim registrovanim korisnicima</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title" style="color: red; font-weight: bold;" >PAŽNJA!!!
                <small>Poruka se šalje svim registrovanim članovima u bazi</small>
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
              <form method="POST" onsubmit="return confirm('Da li ste sigurni da želite da pošaljete ovu poruku svim registrovanim članovima u bazi?');">
                <input type="text" name="naslov_vest" class="form-control" placeholder="Naslov poruke..." style="margin-bottom: 10px;" required>
                <textarea class="textarea" name="vest" placeholder="Ovde ide tekst poruke..." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required ></textarea>
                <input type="submit" name="submit_vest" class="btn btn-info" value="Pošalji vest">
              </form>
            </div>
          </div>
          <!-- /.box -->
