...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          <a href="#"><i class="fa fa-picture-o"></i> <span>Fotografije</span>
          </a>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       FOTOGRAFIJE
        <small>Uvoz fotografije na server</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title" style="color: green; font-weight: bold;" >UVOZ FOTOGRAFIJE
                <small>Odaberi i uvezi fotografiju za slanje u obaveštenjima</small>
              </h3>
            </div>
            <!-- /.box-header -->
              ...
              <form role="form">
                <div class="box-body">
                  <div class="form-group">
                    <label for="naziv_slike">Naziv slike</label>
                    <input type="text" name="naziv_slike" class="form-control" placeholder="Upiši naziv slike...">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Odaberi sliku</label>
